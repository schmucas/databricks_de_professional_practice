...
def test_normalize_vehicle_telemetry(spark):
    ...
    expected = spark.createDataFrame([
        (1, "2026-06-24 10:00:00", 5.0, 90.0, 50.0, 10000, 80.0, "V001", "active"),
        (2, "2026-06-24 11:00:00", None, 100.0, 60.0, 20000, 100.0, "V002", "inactive"),
        (3, "2026-06-24 12:00:00", None, 100.0, 70.0, 30000, 100.0, "V003", "active"),
        (4, "2026-06-23 12:00:00", 10.0, None, 70.0, 30000, 100.0, "V004", "active"),
        (5, "2026-06-23 13:00:00", 10.0, None, 70.0, 30000, 100.0, "V005", "active"),
        (6, "2026-06-23 14:00:00", 10.0, 100.0, 70.0, 30000, None, "V006", "active"),
        (7, "2026-06-23 15:00:00", 10.0, 100.0, 70.0, 30000, None, "V007", "active"),
    ], [
        "reading_id", "reading_timestamp", "cargo_temp_c", "engine_temp_c",
        "fuel_pct", "odometer_km", "speed_kmh", "vehicle_id", "vehicle_status"
    ])
