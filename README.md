...
The 'databricks_de_professional_practice' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/databricks_de_professional_practice/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_de_professional_practice_etl` to your workspace.
