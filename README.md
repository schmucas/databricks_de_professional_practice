...
Together they map to the exam-relevant skills: SCD Type 2 from two different CDC sources, full-load-plus-incremental ingestion, sparse-update post-image reconstruction, data-quality enforcement, deduplication, and data-skew optimisation, both developed via classic pyspark route and the new declerative approach.
